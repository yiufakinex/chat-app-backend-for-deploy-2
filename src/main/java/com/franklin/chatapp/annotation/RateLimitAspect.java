...
import com.franklin.chatapp.exception.RateLimitException;
import com.franklin.chatapp.service.RateLimitService;
    ...
    public Object rateLimitAPI(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (Object arg : args) {
            if (arg instanceof User) {
                User user = (User) arg;
                ConsumptionProbe consumptionProbe = RateLimitService.RateLimiter.rateLimit(user,
